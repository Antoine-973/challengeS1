<template>
    <slot></slot>
    <div class="snackbar">
        <div v-if="open" :class="'alert alert-'+type +' shadow-lg'">
            <div>
            ...
            <div class="flex-none">
                <button @click="closeSnackbar" class="btn btn-sm btn-ghost">Close</button>
            </div>
        </div>
    </div>
</template>
...
provide('SnackbarProvider:openSnackbar', openSnackbar);
